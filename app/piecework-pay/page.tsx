...
const appStoreURL = "https://apps.apple.com/cn/app/%E5%B7%A5%E6%97%B6%E6%A0%B8%E5%AF%B9/id6800185417?ct=github_piecework_pay&mt=8";
  ...
  return (
    <main className="intentPage">
      ...
      <section className="intentHero">
        ...
        <p className="availability">基础记录免费；计件阶梯、多个计薪档案和完整历史可选 ¥28 永久买断或 ¥38/年订阅。</p>
      </section>
