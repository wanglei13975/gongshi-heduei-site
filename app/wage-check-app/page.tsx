...
const appStoreURL = "https://apps.apple.com/cn/app/%E5%B7%A5%E6%97%B6%E6%A0%B8%E5%AF%B9/id6800185417?ct=github_wage_check_app&mt=8";
  ...
  return (
    <main className="intentPage">
      ...
      <section className="intentHero">
        ...
        <p className="availability">基础记录和简单计薪免费；复杂规则、完整历史、趋势和小组件可选 ¥28 永久买断或 ¥38/年订阅。</p>
      </section>
